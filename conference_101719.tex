...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig1_mape_chain_length.png}
\caption{MAPE scaling with chain length. GraphMCMNet demonstrates superior generalization to out-of-distribution lengths ($n>35$).}
\label{fig:scaling}
\end{figure}
