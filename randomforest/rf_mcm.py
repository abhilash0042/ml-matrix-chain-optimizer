...
# Target is log₁₀(cost+1) — back-transform after prediction
# ============================================================
rf = RandomForestRegressor(
    ...
    min_samples_split = 2,
    min_samples_leaf  = 1,
    max_features    = 'sqrt',   # sqrt(30) ≈ 5-6 features per split
    bootstrap       = True,
...
# ============================================================
joblib.dump(rf, 'rf_results/rf_model.pkl')
print("\nModel saved → rf_results/rf_model.pkl")
...
with open('rf_results/rf_results.json', 'w') as f:
    json.dump(results, f, indent=2)
print("Results saved → rf_results/rf_results.json")
...
plt.tight_layout()
plt.savefig('rf_results/plot1_true_vs_pred.png', dpi=130, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('rf_results/plot2_feature_importance.png', dpi=130, bbox_inches='tight')
plt.close()
...
axes[1].legend()
plt.tight_layout()
plt.savefig('rf_results/plot3_error_analysis.png', dpi=130, bbox_inches='tight')
plt.close()
...
axes[1].set_ylabel('R²')
plt.tight_layout()
plt.savefig('rf_results/plot4_diagnostics.png', dpi=130, bbox_inches='tight')
plt.close()
...
============================================================
  ...
  rf = joblib.load('rf_results/rf_model.pkl')
